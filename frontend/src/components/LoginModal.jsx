...
function LoginModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" style={{ fontFamily: "'Noto Sans', sans-serif" }}>
      {/* Backdrop */}
      <div 
          ...
          <div className="p-8">
            ...
            <div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-300 rounded-lg px-6 py-3 hover:bg-gray-50 transition-colors shadow-sm"
              >
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">Authorized Personnel Only</span>
                </div>
              </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-xs text-blue-700">
                      This system is for authorized India Post personnel only. 
                      Sign in with your official government email.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center mt-6 pt-6 border-t border-gray-200">
              <div className="flex justify-center items-center space-x-3 mb-3">
                <img src={indiaPostLogo} alt="India Post" className="h-8 w-auto" />
                <img src={digitalIndiaLogo} alt="Digital India" className="h-7 w-auto opacity-80" />
              </div>
